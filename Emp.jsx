    ...
    this.setState({
      ...
      render() {
        return (
            ...
            <table border="4px">
                <tr>
                    <td>EmpId</td><td>Name</td><td>User Name</td><td>Email</td>
                </tr>
                { this.state.people.map(person => <tr><td>{person.id}</td>   <td>{person.name}</td> <td> {person.username}</td> <td> {person.email}</td></tr> )}
